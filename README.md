...
This is an independent community client, not an official OpenAI product. Protocol v2, scoped device credentials, resumable attachments, remote skills/plugins/apps, and reconnect safety are implemented. Internet-facing Hosts require HTTPS/WSS; see the compatibility gates below and the [0.4.0 release notes](docs/releases/0.4.0.md).
